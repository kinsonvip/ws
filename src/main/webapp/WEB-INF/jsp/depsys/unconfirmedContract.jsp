...
<div class="container-fluid">
    ...
    <div class="row" style="height: auto;margin-left: 2%;margin-right: 2%;margin-top: 1%">
        <div id="unconfirmedContractGrid" class="datagrid">
            <div class="row">
...
<script stype="text/javascript">
    $(function(){
        ...
        $('#unconfirmedContractGrid').datagrid({
            dataSource: {
                cols:[
                    ...
                    {name: 'acceptNum', label: '已录用人数',width: 0.1,className: 'text-center'},
            ...
            $.ajax({
                ...
                success: function (data ,textStatus, jqXHR){
                    ...
                    if("success"==data.status){
                        var unconfirmedContractGrid   = $('#unconfirmedContractGrid').data('zui.datagrid');
                        unconfirmedContractGrid.dataSource.data=null;
                        unconfirmedContractGrid.render();
        ...
        $("#recPerPage").change(function () {
            ...
            // 获取数据表格实例
            var unconfirmedContractGrid = $('#unconfirmedContractGrid').data('zui.datagrid');
            unconfirmedContractGrid.setPager(-1,-1,parseInt(recPerPage));
            unconfirmedContractGrid.render();
        })
    })
