...
<div class="total">
    ...
    <div class="modal fade" id="updateModal" style="height: 95%;width: 70%;margin-left: 25%;margin-top: 1%;overflow-x: hidden;overflow-y: hidden; ">
                ...
                <div class="modal-body">
                    <form id="updateForm">
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-2" style="width: 50%">
